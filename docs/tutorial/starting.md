...
Notice how `citation` links to the standard [IEEE 2791-2020](https://doi.org/10.1109/IEEESTD.2020.9094416), as [RO-Crate recommends for citations](https://www.researchobject.org/ro-crate/1.1/contextual-entities.html#publications-via-citation-property), and `subjectOf` to link to the [related website](https://www.researchobject.org/ro-crate/1.1/data-entities.html#embedded-data-entities-that-are-also-on-the-web) <https://www.biocomputeobject.org/> that describes the BCO schema in a more textual way. 

These two new resources we don't describe much further (consumers can click the URIs), but we give them at least `@type` and a `name`. Other properties from <http://schema.org/ScholarlyArticle> and <http://schema.org/WebSite> could also be used:

```
{
    "@id": "https://doi.org/10.1109/IEEESTD.2020.9094416",
    "@type": "ScholarlyWork",
    "name": "IEEE 2791-2020 Standard for Bioinformatics Computations and Analyses Generated by High-Throughput Sequencing (HTS) to Facilitate Communication",
    "alternateName": "IEEE Std 2791-2020"
},
{
    "@id": "https://www.biocomputeobject.org/}",
    "@type": "WebSite",
    "name": "BioCompute Objects",
    "about": { "https://doi.org/10.1109/IEEESTD.2020.9094416" }
}
```
